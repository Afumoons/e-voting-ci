      ...
      <div class="col-md-4 mt-4 mb-4">
        <div class="card">
          ...
          <div class="card-body text-center">
            ...
            <div class="row">
              <div class="col">
                <button type="button" class="btn btn-warning btn-pilih-kandidat" data-id="<?= $kandidat['id_kandidat'] ?>" data-ormawa="<?= $kandidat['ormawa']; ?>">
                  Pilih Kandidat
                </button>
              </div>
              <div class="col">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="<?= base_url('voting/kandidat/pilih') ?>" method="POST">
          ...
          <input type="hidden" name="ormawa" id="kandidat-ormawa" value="">
...
<script>
  $(document).ready(function() {
    ...
    $('.btn-pilih-kandidat').on('click', function(e) {
      ...
      const ormawa = e.target.dataset.ormawa;
      $('#kandidatModal #kandidat-id').val(id);
      $('#kandidatModal #kandidat-ormawa').val(ormawa);
      $('#kandidatModal').modal();
    });
  });
</script>
