          ...
          <div class="steps">
            <div class="row align-item-center">
              ...
              <div class="col-12 col-sm-6 order-sm-1">
                <p class="h1 text-dark text-uppercase">Selamat Datang di E-Voting Pemira App</p>

                <p class="mt-3 text-dark">Aplikasi E-Voting ini dibuat untuk memudahkan dalam pengambilan suara pemilihan calon ketua dan wakil ketua BEM dan delegasi BLM. </p>
